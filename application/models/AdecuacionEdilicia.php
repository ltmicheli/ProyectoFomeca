...
class AdecuacionEdilicia extends CI_Model
{
    protected $table = 'adecuacionedilicia';
    ...
    public function set($idPadre)
    {
        ...
        $this->db->set($this->transmision, substr($this->input->post('totalAdecuacionTransmision'), 1) );
        $this->db->set($this->produccion, substr($this->input->post('totalAdecuacionProduccion'), 1) );
        $this->db->set($this->infraestructura, substr($this->input->post('totalAdecuacionInfraestructura'), 1) );
