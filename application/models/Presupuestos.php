...
class Presupuestos extends CI_Model
{
    ...
    protected $razonSocialProveedor = 'razonSocialProveedor';
    ...
    public function set($idPadre)
    {
        ...
        $tabla = $this->input->post('presupuestos');

        foreach ($tabla as $array) {
          $this->db->set($this->foreignKey, $idPadre );
          $this->db->set($this->razonSocialProveedor, $array['info'] );
