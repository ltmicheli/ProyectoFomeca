...
class DescripcionEquipamiento extends CI_Model
{
    protected $table = 'descripcionequipamientotecnologico';

    protected $primaryKey = 'id';

    protected $foreignKey = 'idEquipamientoTecnologico';
    ...
    {
        $transmision = $this->input->post('equipamientoTransmision');
        $produccion = $this->input->post('equipamientoProduccion');
        $infra = $this->input->post('equipamientoInfra');
        //print_r ($matriz);
        foreach ($transmision as $trans) {
          ...
          $this->db->set($this->cantidad, $trans['cant'] );
          $this->db->set($this->finalidad, $trans['fina'] );
          $this->db->set($this->precioUnitario, $trans['prec'] );
