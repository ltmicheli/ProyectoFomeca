...
class Contraparte extends CI_Model
{
    protected $table = 'contraparte';

    protected $primaryKey = 'id';

    protected $foreignKey = 'idSubsidio';

    protected $rrhhPermanentes = 'rrhhPermanentes';
    ...
    public function set($idPadre)
    {
        ...
        $this->db->set($this->rrhhPermanentes, $this->input->post('totalRrhhPermanentesContraparteResumen') );
        $this->db->set($this->servicios, $this->input->post('serviciosContraparteResumen') );
        $this->db->set($this->otros, $this->input->post('otrosContraparteResumen') );
