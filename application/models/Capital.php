...
class Capital extends CI_Model
{
    ...
    protected $adecuacionEdilicia = 'adecuacionEdilicia';

    protected $equipamientoTecnologico = 'equipamientoTecnologico';
    ...
    public function set($idPadre)
    {
        ...
        $this->db->set($this->adecuacionEdilicia, $this->input->post('totalGastosAdecuacionEdilicia') );
        $this->db->set($this->equipamientoTecnologico, $this->input->post('totalGastosEquipamientoTecnologico') );
