...
class RrhhNoPermanentes extends CI_Model
{
    protected $table = 'rrhhnopermanentes';

    protected $primaryKey = 'id';

    protected $foreignKey = 'idCorriente';

    protected $funcion = 'funcion';

    protected $honorarios = 'honorarios';

    protected $meses = 'meses';
    ...
    public function set($idPadre)
    {
        ...
        $noPermanentes = $this->input->post('rrhhNoPermanentes');

        foreach ($noPermanentes as $array) {
          $this->db->set($this->foreignKey, $idPadre );
          $this->db->set($this->funcion, $array['func'] );
          $this->db->set($this->honorarios, $array['hono'] );
          $this->db->set($this->meses, $array['cant'] );
