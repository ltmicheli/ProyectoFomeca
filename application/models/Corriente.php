...
class Corriente extends CI_Model
{
    protected $table = 'corriente';

    protected $tablePadre = 'subsidio';

    protected $primaryKey = 'id';

    protected $foreignKey = 'idSubsidio';

    protected $rrhhNoPermanentes = 'rrhhNoPermanentes';
    ...
    public function set($idPadre)
    {
        ...
        $this->db->set($this->rrhhNoPermanentes, $this->input->post('totalGastosRrhhNoPermanentes') );
        $this->db->set($this->viaticos, $this->input->post('totalGastosViaticos') );
